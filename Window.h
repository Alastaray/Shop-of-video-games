...
public:
	...
	template <class type>
	void FillRow(type val, int pos_x, int pos_y, int indent_x = 1, int indent_y = 1);
protected:	
	enum Borders_name
	{
		TopLeftAngle,
...
public:
	...
	void DrawActiveBut(int pos_x = 0, int pos_y = 0, int indent_x = 1, int indent_y = 1){ FillRow(name, pos_x, pos_y, indent_x, indent_y); }
